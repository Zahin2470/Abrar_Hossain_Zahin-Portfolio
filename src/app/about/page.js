      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
          <h2 className="font-black mb-8 text-white"
            style={{ fontSize: "clamp(2rem,5vw,3rem)", fontFamily: "'Syne',sans-serif", letterSpacing: "-0.03em" }}>
            Social Profiles
          </h2>
          ...
          <div className="grid lg:grid-cols-3 gap-8 items-start">
            ...
            <div>
              <p className="text-xs font-mono text-zinc-600 uppercase tracking-widest mb-3"> kaggle Stats | live</p>
              <KaggleBadge />
            </div>
          </div>
        </motion.div>
